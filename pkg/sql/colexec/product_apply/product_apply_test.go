...
type productApplyTestCase struct {
	arg    *ProductApply
...
func newTestCase(flgs []bool, ts []types.Type, rp []colexec.ResultPos) productApplyTestCase {
...
func hashBuild(t *testing.T, tc productApplyTestCase) []*batch.Batch {
